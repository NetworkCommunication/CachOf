...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims, n_actions, name,
        ...
        self.checkpoint_file = os.path.join(name + 'ddpg')
...
# gamma=0.99 layer1=400 layer2=300,batch=64
class Agent(object):
    # TODO 也许layer1_size  layer2_size 需要更改
    def __init__(self, alpha, beta, input_dims, tau, n_actions, env,
                 gamma=0.99, max_size=10000, layer1_size=500,
