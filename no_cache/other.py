...
def get_popularity_slice(popularity):
    res = []
    popularity_slice1 = []
    popularity_slice2 = []
    popularity_slice3 = []

    random_popularity = random.choice(popularity)
    popularity_slice1.append(random_popularity)
    popularity_slice2.append(random_popularity)
    popularity_slice3.append(random_popularity)
...
def generate_rsus(num_app1, num_app2, num_task, fn_bs, fn_app, delay_constraints, cache_capacity):
    ...
    popularity_slice1 = get_popularity_slice(popularity)
    rsu2_apps = generate_apps(num_app2, num_task, fn_app, delay_constraints)  # Generating 15 apps for RSU 2
    popularity_slice2 = get_popularity_slice(popularity)
